...
public class Main {
    ...
    public static void mostrarDatosCursoBreve(Document curso) {
    ...
    public static void mostrarDatosCursoDetallado(Document curso) {
    	mostrarDatosCursoBreve(curso);
    ...
    public static void mostrarCurso() {
        ...
        try {
            ...
            for(Document curso : collectionCursos.find(
                ...
                mostrarDatosCursoDetallado(curso);
    ...
    public static void verCursosAlumno() {
        ...
        try {
            ...
            // Document alumno = introducirAlumnos(1).get(0);
            System.out.print("Dime el código del alumno: ");
            int codigo = sc.nextInt();
            
            for(Document curso : collectionCursos.find(
                    new Document("alumnos.codigo",codigo))) {
